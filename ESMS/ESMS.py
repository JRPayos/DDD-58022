...
def delete():
    ...
    messagebox.showinfo('Students Data ', "Student's Data has been deleted successfully")
...
gender_reg = tk.Label(registerframe, text='Gender:', bg='#1e4382', fg='white', font=('Arial', 12, 'bold'))
...
register_button = tk.Button(db_button_frame, text='REGISTER RECORD', bg='gray', fg='white', font=('Arial', 10, 'bold'), width=25,
                            command=register)
register_button.grid(row=0, column=0)
refresh_button = tk.Button(db_button_frame, text='REFRESH RECORDS', bg='gray', fg='white', font=('Arial', 10, 'bold'), width=25, command=refresh)
refresh_button.grid(row=0, column=1, padx=10)
delete_button = tk.Button(db_button_frame, text='DELETE RECORD', bg='gray', fg='white', font=('Arial', 10, 'bold'), width=25, command=delete)
